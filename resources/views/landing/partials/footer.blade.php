<footer class="text-center" style="font-family: ABeeZee, sans-serif; background: var(--bs-white);">
    <div class="container text-muted py-4 py-lg-5">
        ...
        <ul class="list-inline">
            <li class="list-inline-item me-4"> <a href="mailto:smkn1kotabengkulu@gmail.com">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                        viewBox="0 0 16 16" class="bi bi-send">
            ...
            <li class="list-inline-item me-4"> <a href="tel:+6289632046116">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
        ...
        <p class="mb-0">Copyright © 2022 PresensiKu</p>
    </div>
</footer>
