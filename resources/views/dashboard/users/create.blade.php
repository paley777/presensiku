...
@section('container')
    <div class="container" style="font-family: ABeeZee, sans-serif;">
        ...
        <div class="row mb-5">
            ...
            <form class="row g-2 needs-validation" method="post" action="/dashboard/users">
                @csrf
                ...
                <div class="col-md-3 position-relative">
                    ...
                    <input type="text"
                        ...
                        id="validationCustom01" class="form-control" name="nip" placeholder="Isi NIP Anda" required>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" id="validationCustom01"
                        onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
                        class="form-control" name="no_hp" placeholder="Isi Nomor Telepon Anda" required>
                </div>
